...
import { ADMIN_ADDRESS, PANECOLAB_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'cake', params: { symbol: 'ECOLAB', address: getCakeAddress(), decimals: 18 } }],
  }
}
